...
flowchart TD
    ...
    subgraph S0 ["Stage 0: Product Discovery (Optional)"]
        ...
        A0["Outputs:<br>00_IDEATION.md and<br>visual-dashboard.html (Discovery Tab)"]:::artifact
    ...
    subgraph S1 ["Stage 1: Socratic Alignment"]
        ...
        A1["Outputs:<br>docs/glossary.md,<br>docs/adr/ and<br>visual-dashboard.html (Glossary Tab)"]:::artifact
    ...
    subgraph S2 ["Stage 2: Product Requirements"]
        ...
        A2["Outputs:<br>02_PRD.md and<br>visual-dashboard.html (PRD Tab)"]:::artifact
    ...
    subgraph S3 ["Stage 3: Context Extraction"]
        ...
        A3["Outputs:<br>03_EXTRACTION.md and<br>visual-dashboard.html (Extraction Tab)"]:::artifact
    ...
    subgraph S45 ["Stages 4 and 5: Spec and Plan"]
        ...
        A5["Output:<br>05_PLAN.md and<br>visual-dashboard.html (Overview Tab)"]:::artifact
    ...
    subgraph S8 ["Stage 8: Automated Walkthrough"]
        ...
        C8["Command: /record<br>- Skill: record / asciinema"]:::component
        A8["Outputs:<br>08_WALKTHROUGH.md and<br>visual-dashboard.html (Recap Tab)"]:::artifact
    ...
    subgraph S9 ["Stage 9: PR Delivery and Maintenance"]
        ...
        A9["Outputs:<br>Active GitHub PR<br>and clean workspace"]:::artifact
