...
- **UI Visibility / Artifact Mirroring**: In addition to saving the documents in the workspace, you MUST write or copy them directly into the assistant's private system artifacts directory (`/home/robedwards/.gemini/antigravity/brain/<conversation-id>/`) with the correct ArtifactMetadata:
  ...
  - Copy `visual-dashboard.html` to `/home/robedwards/.gemini/antigravity/brain/<conversation-id>/00_visual-dashboard.html`
...
3. **Compile the Visual PRD inside the Unified Dashboard (`visual-dashboard.html`)**:
   - Copy `/home/robedwards/workspace/bean-to-cup/templates/visual-dashboard.html` to the target path.
